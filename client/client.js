...
Template.body.events({
	...
	"click .faq": function () {
		bootbox.dialog({
			...
			<p>First of all, that wasn't a question. We're currently in the process of building our database and everything will be in soon.
         Please shoot us an email at princetonmealscout@gmail.com with your requested dining hall, menu itmem, and phone number, and we'll enter
         it for you once our database is finished!</p><br> \
